...
#ifndef INTERCEPTOR_DLL
#define INTERCEPTOR_DLL __attribute__((visibility("default")))
#endif
// -----------------------------------------------------------------------------
...
INTERCEPTOR_DLL void *InitializeInterceptor();
...
// undefined behaviour.
INTERCEPTOR_DLL void TerminateInterceptor(void *interceptor);
...
INTERCEPTOR_DLL bool InterceptFunction(void *interceptor, void *old_function,
